...
#include <stdlib.h>
#include <string.h>
//#define cantidad 5 //cambio la cantidad

void cargarNombres(char **lista, int cantidad);
void mostrarNombres(char **lista, int cantidad);
...
int main()
{
    ...
    cargarNombres(lista, cantidad);
    mostrarNombres(lista, cantidad);
